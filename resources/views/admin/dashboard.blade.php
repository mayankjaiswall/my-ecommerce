    ...
    <div class="admin-stats-grid">
        <div class="admin-stat-card">
            <div class="admin-stat-card__top">
                <span class="admin-stat-card__icon" style="background: linear-gradient(135deg,#6a5cf5,#8b7bff);">
        ...
        <div class="admin-stat-card">
            <div class="admin-stat-card__top">
                <span class="admin-stat-card__icon" style="background: linear-gradient(135deg,#f5a623,#f7c15e);">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="admin-stat-card">
            <div class="admin-stat-card__top">
                <span class="admin-stat-card__icon" style="background: linear-gradient(135deg,#22c3a6,#39d9bc);">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="admin-stat-card">
            <div class="admin-stat-card__top">
                <span class="admin-stat-card__icon" style="background: linear-gradient(135deg,#ef4565,#f56b86);">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="admin-legend">
                @foreach ($roleBreakdown as $index => $role)
                    <div class="admin-legend__item">
                        <span class="admin-legend__dot" style="background: {{ $index % 2 === 0 ? '#6a5cf5' : '#22c3a6' }};"></span>
                    ...
                    <tr>
                        <td>
                            <div class="admin-table-user">
                                <span class="admin-avatar" style="background: linear-gradient(135deg,#6a5cf5,#8b7bff);">
        ...
        new Chart(growthCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: @json($trendData),
                    borderColor: '#6a5cf5',
                    backgroundColor: 'rgba(106, 92, 245, 0.12)',
                    borderWidth: 2.5,
                    tension: 0.4,
                    fill: true,
                    pointRadius: 4,
                    pointBackgroundColor: '#6a5cf5',
            ...
            options: {
                ...
                scales: {
                    y: { beginAtZero: true, ticks: { precision: 0 }, grid: { color: '#f0f0f8' } },
        ...
        new Chart(roleCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ['#6a5cf5', '#22c3a6', '#f5a623', '#ef4565'],
                    borderWidth: 0,
                }]
            },
            options: {
