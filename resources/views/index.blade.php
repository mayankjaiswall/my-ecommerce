        ...
        <div class="position-relative">
          <div class="swiper-container js-swiper-slider" data-settings='{
            ...
            <div class="swiper-wrapper">
              @forelse ($categories as $category)
                <div class="swiper-slide">
                  <img loading="lazy" class="w-100 h-auto mb-3"
                    src="{{ asset('assets/images/home/demo3/category_' . (($loop->index % 8) + 1) . '.png') }}"
                    width="124" height="124" alt="{{ $category->category_name }}" />
                  <div class="text-center">
                    <a href="{{ route('shop', ['category' => $category->slug]) }}" class="menu-link fw-medium">
              ...
              @empty
                <div class="swiper-slide">
                  <div class="text-center text-secondary">No categories yet.</div>
                </div>
              @endforelse
            </div><!-- /.swiper-wrapper -->
